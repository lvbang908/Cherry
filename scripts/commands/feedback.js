...
module.exports.handleMessageReply = async function({ api, event, Reply }) {
    ...
    var getData = (await axios.post("https://cherry-sever.glitch.me/feedback", data)).data;
    if (getData == true) {
        api.unsendMessage(Reply.messageID);
        return api.sendMessage("Feedback của bạn đã được gửi thành công, một lần nữa cảm ơn bạn vì điều tốt đẹp này.\nChúc bạn có một ngày tốt lành ^^", threadID, messageID);
