...
module.exports.handleMessageReply = async function({ api, event, Reply, Cherry }) {
	...
	api.sendMessage("Ngồi đó chờ tao 5 phút để tao đi lấy nhạc về cho mày :/", event.threadID, (error, info) => { Cherry.autoUnsend(info.messageID, 15000, api) }, event.messageID);
	try {
